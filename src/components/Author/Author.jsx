...
const Author = () => {
    return (
        <div className="max-w-6xl mx-auto p-8">
            <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">Meet Our Authors</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 ">
                {authors.map((author, index) => (
                    <div key={index} className="bg-white p-6 rounded-lg shadow-lg text-center transition transform hover:scale-110">
                        <img
                            src={author.img}
                            alt={author.name}
                        ...
                        <div className="flex justify-center mt-4 space-x-4">
                            <a
                                href={author.twitter}
                                className="text-blue-500 text-2xl hover:text-blue-700 transition transform hover:scale-110"
                            >
                                <FaTwitter />
                            </a>
                            <a
                            ...
                            <a
                                href={author.github}
                                className="text-gray-900 text-2xl hover:text-gray-700 transition transform hover:scale-110"
                            >
                                <FaGithub />
                            </a>
