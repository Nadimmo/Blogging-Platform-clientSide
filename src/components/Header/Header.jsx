...
const Header = () => {
    const Links = <>
        ...
        <li><NavLink to="/blogs" className="text-lg font-medium hover:text-blue-500 transition">All Blogs</NavLink></li>
        <li><NavLink to="/singleBlogs" className="text-lg font-medium hover:text-blue-500 transition">Single Blogs</NavLink></li>
